...
import { Database, HardDrive, ArrowRight, CheckCircle, AlertCircle } from 'lucide-react'
import useStorage, { getStorageMethod, getStorageInfo } from '../hooks/useStorageMigration'
...
const StorageDemo = () => {
  ...
  const [notes, setNotes, deleteNotes, isLoading, error] = useStorage('demo-notes', [], {
  ...
  const [text, setText, deleteText, textLoading, textError] = useStorage('demo-text', '')
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      >
        ...
        {/* Text Input Demo */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-white mb-3">Text Storage Demo</h3>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-semibold text-white">Notes Storage Demo</h3>
            <button
              onClick={addNote}
